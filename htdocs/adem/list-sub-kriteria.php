...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	...
	<a href="cetak-sub-kriteria.php" target="_blank" class="btn btn-primary"> <i class="fa fa-print"></i> Cetak Data </a>
</div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="d-sm-flex align-items-center justify-content-between">
			<h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-table"></i> <?= $data['nama']." (".$data['id_kriteria'].")  [".$data['info']."]" ?></h6>

  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">SPK ADEM</div>
      </a>
	  ...
	  <li class="nav-item <?php if($page == "Hasil-SPK"){echo "active";} ?>">
        <a class="nav-link" href="hasil-spk.php">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Data Hasil Electre</span></a>
      </li>	
	  ...
	  <li class="nav-item <?php if($page == "Profile"){echo "active";} ?>">
	   ...
	   <li class="nav-item <?php if($page == "Setting"){echo "active";} ?>">
        <a class="nav-link" href="list-setting.php">
          <i class="fas fa-fw fa-user"></i>
